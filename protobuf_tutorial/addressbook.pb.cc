...
const ::google::protobuf::Descriptor* Person_AddressBook_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  Person_AddressBook_reflection_ = NULL;
...
void protobuf_AssignDesc_addressbook_2eproto() {
  ...
  Person_PhoneNumber_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      -1);
  Person_AddressBook_descriptor_ = Person_descriptor_->nested_type(1);
  static const int Person_AddressBook_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Person_AddressBook, people_),
  };
  Person_AddressBook_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      Person_AddressBook_descriptor_,
      Person_AddressBook::default_instance_,
      Person_AddressBook_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Person_AddressBook, _has_bits_[0]),
      -1,
      -1,
      sizeof(Person_AddressBook),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Person_AddressBook, _internal_metadata_),
      -1);
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      Person_AddressBook_descriptor_, &Person_AddressBook::default_instance());
}
...
void protobuf_ShutdownFile_addressbook_2eproto() {
  ...
  delete Person_AddressBook::default_instance_;
  delete Person_AddressBook_reflection_;
}
...
void protobuf_AddDesc_addressbook_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\021addressbook.proto\022\010tutorial\"\214\002\n\006Person"
  ...
  Person_AddressBook::default_instance_ = new Person_AddressBook();
  Person::default_instance_->InitAsDefaultInstance();
  Person_PhoneNumber::default_instance_->InitAsDefaultInstance();
  Person_AddressBook::default_instance_->InitAsDefaultInstance();
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int Person_AddressBook::kPeopleFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

Person_AddressBook::Person_AddressBook()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:tutorial.Person.AddressBook)
}

void Person_AddressBook::InitAsDefaultInstance() {
}

Person_AddressBook::Person_AddressBook(const Person_AddressBook& from)
  : ::google::protobuf::Message(),
    _internal_metadata_(NULL) {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:tutorial.Person.AddressBook)
}

void Person_AddressBook::SharedCtor() {
  _cached_size_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}

Person_AddressBook::~Person_AddressBook() {
  // @@protoc_insertion_point(destructor:tutorial.Person.AddressBook)
  SharedDtor();
}

void Person_AddressBook::SharedDtor() {
  if (this != default_instance_) {
  }
}

void Person_AddressBook::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* Person_AddressBook::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return Person_AddressBook_descriptor_;
}

const Person_AddressBook& Person_AddressBook::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_addressbook_2eproto();
  return *default_instance_;
}

Person_AddressBook* Person_AddressBook::default_instance_ = NULL;

Person_AddressBook* Person_AddressBook::New(::google::protobuf::Arena* arena) const {
  Person_AddressBook* n = new Person_AddressBook;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void Person_AddressBook::Clear() {
// @@protoc_insertion_point(message_clear_start:tutorial.Person.AddressBook)
  people_.Clear();
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  if (_internal_metadata_.have_unknown_fields()) {
    mutable_unknown_fields()->Clear();
...
bool Person_AddressBook::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:tutorial.Person.AddressBook)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:tutorial.Person.AddressBook)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:tutorial.Person.AddressBook)
  return false;
#undef DO_
}

void Person_AddressBook::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:tutorial.Person.AddressBook)
  // repeated .tutorial.Person people = 1;
  ...
  // @@protoc_insertion_point(serialize_end:tutorial.Person.AddressBook)
}

::google::protobuf::uint8* Person_AddressBook::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:tutorial.Person.AddressBook)
  // repeated .tutorial.Person people = 1;
  for (unsigned int i = 0, n = this->people_size(); i < n; i++) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tutorial.Person.AddressBook)
  return target;
}

int Person_AddressBook::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:tutorial.Person.AddressBook)
  int total_size = 0;
...
void Person_AddressBook::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:tutorial.Person.AddressBook)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
  const Person_AddressBook* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const Person_AddressBook>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:tutorial.Person.AddressBook)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:tutorial.Person.AddressBook)
    MergeFrom(*source);
  }
}

void Person_AddressBook::MergeFrom(const Person_AddressBook& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:tutorial.Person.AddressBook)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
void Person_AddressBook::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:tutorial.Person.AddressBook)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Person_AddressBook::CopyFrom(const Person_AddressBook& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:tutorial.Person.AddressBook)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Person_AddressBook::IsInitialized() const {

  if (!::google::protobuf::internal::AllAreInitialized(this->people())) return false;
  return true;
}

void Person_AddressBook::Swap(Person_AddressBook* other) {
  if (other == this) return;
  InternalSwap(other);
}
void Person_AddressBook::InternalSwap(Person_AddressBook* other) {
...
::google::protobuf::Metadata Person_AddressBook::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = Person_AddressBook_descriptor_;
  metadata.reflection = Person_AddressBook_reflection_;
  return metadata;
}
...
// repeated .tutorial.Person people = 1;
int Person_AddressBook::people_size() const {
  return people_.size();
}
void Person_AddressBook::clear_people() {
  people_.Clear();
}
const ::tutorial::Person& Person_AddressBook::people(int index) const {
  // @@protoc_insertion_point(field_get:tutorial.Person.AddressBook.people)
  return people_.Get(index);
}
::tutorial::Person* Person_AddressBook::mutable_people(int index) {
  // @@protoc_insertion_point(field_mutable:tutorial.Person.AddressBook.people)
  return people_.Mutable(index);
}
::tutorial::Person* Person_AddressBook::add_people() {
  // @@protoc_insertion_point(field_add:tutorial.Person.AddressBook.people)
  return people_.Add();
}
::google::protobuf::RepeatedPtrField< ::tutorial::Person >*
Person_AddressBook::mutable_people() {
  // @@protoc_insertion_point(field_mutable_list:tutorial.Person.AddressBook.people)
  return &people_;
}
const ::google::protobuf::RepeatedPtrField< ::tutorial::Person >&
Person_AddressBook::people() const {
  // @@protoc_insertion_point(field_list:tutorial.Person.AddressBook.people)
  return people_;
}
