...
class Person_AddressBook : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tutorial.Person.AddressBook) */ {
 public:
  Person_AddressBook();
  virtual ~Person_AddressBook();

  Person_AddressBook(const Person_AddressBook& from);

  inline Person_AddressBook& operator=(const Person_AddressBook& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const Person_AddressBook& default_instance();

  void Swap(Person_AddressBook* other);

  // implements Message ----------------------------------------------

  inline Person_AddressBook* New() const { return New(NULL); }

  Person_AddressBook* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const Person_AddressBook& from);
  void MergeFrom(const Person_AddressBook& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(Person_AddressBook* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static Person_AddressBook* default_instance_;
};
// -------------------------------------------------------------------
...
class Person : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tutorial.Person) */ {
 public:
  ...
  typedef Person_AddressBook AddressBook;
...
// repeated .tutorial.Person people = 1;
inline int Person_AddressBook::people_size() const {
  return people_.size();
}
inline void Person_AddressBook::clear_people() {
  people_.Clear();
}
inline const ::tutorial::Person& Person_AddressBook::people(int index) const {
  // @@protoc_insertion_point(field_get:tutorial.Person.AddressBook.people)
  return people_.Get(index);
}
inline ::tutorial::Person* Person_AddressBook::mutable_people(int index) {
  // @@protoc_insertion_point(field_mutable:tutorial.Person.AddressBook.people)
  return people_.Mutable(index);
}
inline ::tutorial::Person* Person_AddressBook::add_people() {
