...
_PERSON_ADDRESSBOOK = _descriptor.Descriptor(
  name='AddressBook',
  full_name='tutorial.Person.AddressBook',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='people', full_name='tutorial.Person.AddressBook.people', index=0,
...
_PERSON = _descriptor.Descriptor(
  ...
  nested_types=[_PERSON_PHONENUMBER, _PERSON_ADDRESSBOOK, ],
  enum_types=[
    _PERSON_PHONETYPE,
  ],
  options=None,
...
_PERSON_ADDRESSBOOK.fields_by_name['people'].message_type = _PERSON
_PERSON_ADDRESSBOOK.containing_type = _PERSON
...
Person = _reflection.GeneratedProtocolMessageType('Person', (_message.Message,), dict(
  ...
  AddressBook = _reflection.GeneratedProtocolMessageType('AddressBook', (_message.Message,), dict(
    DESCRIPTOR = _PERSON_ADDRESSBOOK,
    __module__ = 'addressbook_pb2'
...
_sym_db.RegisterMessage(Person.AddressBook)
